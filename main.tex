...
\documentclass[doctor]{thesisUESTC}

\title{Thesis Template of UESTC}
\author{王稳}
...
频域方法的研究开展较早，目前应用广泛的包括：矩量法（MOM）\citing{bibson,martin}及其快速算
法多层快速多极子（MLFMA）\citing{wangchangqing}方法、有限元（FEM）\citing{hujun,jianmingjin}方法、自适应积分（AIM）
\citing{jianmingjin}方法等，这些方法是目前计算电磁学商用软件
...
\centering
\subfigure[]{
\label{picb} %% label for first subfigure
\includegraphics[width=7.3cm]{picb.pdf}}
\subfigure[]{
\label{picc} %% label for second subfigure
\includegraphics[width=6.41cm]{picc.pdf}}
\caption{调制高斯脉冲时域与频率波形}
...
\section{时域积分方程时间步进算法阻抗矩阵的存储}
时域阻抗元素的存储技术也是时间步进算法并行化的关键技术之一\citing{bibson}，采用
...
\centering
\subfigure[]{
\label{picd} %% label for first subfigure
\includegraphics[width=6.77cm]{picd.pdf}}
\subfigure[]{
\label{pice} %% label for second subfigure
...
\bibitem{fastcem} W. C. Chew, J. M. Jin, E. Michielssen, et al. Fast and Efficient Algorithm in Computational Electromagnetics[M]. Boston: Artech House, 2000
\bibitem{shengxinqing} 盛新庆. 计算电磁学要论[M]. 北京: 科学出版社, 2004
\bibitem{bzwang} 王秉中. 计算电磁学[M]. 北京: 科学出版社, 2004
\bibitem{lvyinghua} 吕英华. 计算电磁学的数值方法[M]. 北京. 清华大学出版社, 2006
\bibitem{wangchangqing} 王长清. 现代计算电磁学基础[M]. 北京: 北京大学出版社, 2005
\bibitem{panxiaomin} 潘小敏. 计算电磁学中的并行技术及应用[D]. 北京: 中国科学院电子学研究所, 2006
\bibitem{GB3100} 中华人民共和国国家技术监督局. GB3100-3102. 中华人民共和国国家标准--量与单位[S]. 北京: 中国标准出版社, 1994年11月1日
\bibitem{bibson} W. C. Gibson. The Method of Moment in Electromagnetics[M]. New York: Chapman and Hall/CRC, 2008
\bibitem{hujun} 胡俊. 复杂目标矢量电磁散射的高效算法--快速多极子方法及应用[D]. 成都: 电子科技大学, 2000
\bibitem{martin} H. C. Martin, G. F. Carey. Introduction to Finite Element Analysis: Theory and Application[M]. New York: McGraw Hill, 1973
\bibitem{jianmingjin} 金建铭（著）, 王建国（译）.电磁场有限元方法[M]. 西安: 西安电子科技大学出版社, 1998
...
\bibitem{ac1} 盛新庆. 计算电磁学要论[M]. 北京: 科学出版社, 2004
\bibitem{ac2} 王秉中. 计算电磁学[M]. 北京: 科学出版社, 2004
\bibitem{ac3} 吕英华. 计算电磁学的数值方法[M]. 北京. 清华大学出版社, 2006
\bibitem{ac4} 王长清. 现代计算电磁学基础[M]. 北京: 北京大学出版社, 2005
\bibitem{ac5} 潘小敏. 计算电磁学中的并行技术及应用[D]. 北京: 中国科学院电子学研究所, 2006
